                            ...
                            foreach (var member in interfaceType.GetMembers().OrderBy(m => m.Name))
                            {
                                switch (member)
                                {
                                    ...
                                    case IPropertySymbol propertySymbol:
                                        code.AppendLine($"// Interface properties are not supported yet. Cannot expose {interfaceType.FullName()}.{member.Name}");
                                        receiver.Log.Add($"// Interface properties  are not supported yet. Cannot expose {interfaceType.FullName()}.{member.Name}");
